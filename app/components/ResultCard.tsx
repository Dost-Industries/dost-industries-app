...
export default function ResultCard({
  ...
  return (
    <div className="group relative mt-7 overflow-hidden rounded-[24px] border border-cyan-400/30 bg-black/75 backdrop-blur-xl shadow-[0_0_90px_rgba(0,255,255,0.12)] transition-all duration-500 hover:shadow-[0_0_120px_rgba(0,255,255,0.22)]">
